...
{
    [Area("Manage")]
    public class CuriourImagefourController : Controller
    {
        private AppDbContext _context;
        private IWebHostEnvironment _env;

        public CuriourImagefourController(AppDbContext context, IWebHostEnvironment env)
        {
            _context = context;
            _env = env;
        }
        ...
        {
            List<CuriorThree> curior = _context.curiorThree.ToList();
            return View(curior);
        }
        ...
        public IActionResult Update(int Id)
        {
            ...
            CuriorThree curior = _context.curiorThree.Find(Id);
        ...
        public async Task<IActionResult> Update(int Id, Curior curior)
        {
            ...
            CuriorThree curior1 = _context.curiorThree.Find(Id);
            if (curior1 == null)
            {
                return NotFound();
            }
        ...
        public IActionResult Delete(int Id)
        {
            ...
            _context.curiorThree.Remove(curior);
            _context.SaveChanges();
            return RedirectToAction(nameof(Index));
        }
    }
